...
class UI() :
    def __init__(self, parent) :
        ...
        #Display selection
        l1 = Label(parent, text = "Select the output display(s).", pady = 5, padx = 5, relief = RAISED).grid(row = 1, column = 1, sticky = W, pady = (0, 3))
        self.display = IntVar()
        ...
        b2 = Button(parent, text = "Select", padx = 5, pady = 5, bd = 3, command = run).grid(row = 5, column = 1, sticky = E, pady = (3, 0))
